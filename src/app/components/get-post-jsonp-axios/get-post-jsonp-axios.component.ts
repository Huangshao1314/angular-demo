...
@Component({
  selector: 'app-get-post-jsonp-axios',
  templateUrl: './get-post-jsonp-axios.component.html',
  styleUrls: ['./get-post-jsonp-axios.component.scss']
})
export class GetPostJsonpAxiosComponent implements OnInit {
